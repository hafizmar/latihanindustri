    <nav class="navbar-default navbar-static-side" role="navigation">
        <div class="sidebar-collapse">
            <ul class="nav metismenu" id="side-menu">
                ...
                <li>
                    <a href="#"><i class="fa fa-university"></i> <span class="nav-label">Pelajar</span><span class="fa arrow"></span></a>
                    <ul class="nav nav-second-level collapse">
                        <li><a href="#">Senarai Berdaftar</a></li>
                        <li><a href="#">Senarai Tamat Tempoh</a></li>
                    </ul>
                </li>
                <li>
                ...
                <li>
                    <a href=""><i class="fa fa-wrench"></i> <span class="nav-label">Profile</span></a>
                </li>
            </ul>
